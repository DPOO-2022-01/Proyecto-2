...
public class PanelListaParticipantes extends JPanel {
    ...
    private void set_table() {
        ...
        /*for (int i = 0; i < PapeleriaProductos.size(); i++) {

            model.addRow(new Object[]{PapeleriaProductos.get(i).getId(), PapeleriaProductos.get(i).getNombre(), PapeleriaProductos.get(i).getValor()});
            ...
            btnNewButton.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent e) {
                    almacen.Producto(IdProducto.getText(), NombreProducto.getText(), ValorProducto.getText());
                    agregar();
    ...
    private void agregarFilas(DefaultTableModel model) {
